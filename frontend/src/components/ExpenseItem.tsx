...
const ExpenseItem = ({ expense }: ExpenseItemProps) => {
  return (
    <div className="bg-white shadow-md rounded-lg p-4 my-2 flex justify-between items-center">
      <div>
      ...
      <div className="text-right">
        ...
        <p className="text-xl font-bold text-indigo-600">${expense.amount.toFixed(2)}</p>
      </div>
    </div>
  );
};
